                                    ...
                                    <div className="flex-1 min-w-0 flex flex-col justify-between">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                ...
                                                >
                                                    <Link href={`/m/company/tenant/${tenant._id}`} className="flex items-center gap-1">
                                                ...
                                                >
                                                    <Link href={`/m/company/tenant/${tenant._id}/edit`} className="flex items-center gap-1">
